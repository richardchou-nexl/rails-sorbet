...
class Kamal::Cli::App < ::Kamal::Cli::Base
  ...
  # source://kamal//lib/kamal/cli/app.rb#174
  def containers; end

  # source://kamal//lib/kamal/cli/app.rb#93
  def details; end
  ...
  # source://kamal//lib/kamal/cli/app.rb#268
  def live; end

  # source://kamal//lib/kamal/cli/app.rb#218
  def logs; end

  # source://kamal//lib/kamal/cli/app.rb#283
  def maintenance; end

  # source://kamal//lib/kamal/cli/app.rb#258
  def remove; end

  # source://kamal//lib/kamal/cli/app.rb#336
  def remove_app_directories; end

  # source://kamal//lib/kamal/cli/app.rb#298
  def remove_container(version); end

  # source://kamal//lib/kamal/cli/app.rb#312
  def remove_containers; end

  # source://kamal//lib/kamal/cli/app.rb#326
  def remove_images; end

  # source://kamal//lib/kamal/cli/app.rb#180
  def stale_containers; end

  # source://kamal//lib/kamal/cli/app.rb#45
  def start; end

  # source://kamal//lib/kamal/cli/app.rb#68
  def stop; end

  # source://kamal//lib/kamal/cli/app.rb#353
  def version; end

  private

  # source://kamal//lib/kamal/cli/app.rb#375
  def current_running_version(host: T.unsafe(nil)); end

  # source://kamal//lib/kamal/cli/app.rb#396
  def host_boot_groups; end

  # source://kamal//lib/kamal/cli/app.rb#361
  def using_version(new_version); end

  # source://kamal//lib/kamal/cli/app.rb#384
  def version_or_latest; end

  # source://kamal//lib/kamal/cli/app.rb#388
...
class Kamal::Commands::Accessory < ::Kamal::Commands::Base
  ...
  # source://kamal//lib/kamal/commands/accessory.rb#104
  ...
  # source://kamal//lib/kamal/commands/accessory.rb#56
  def execute_in_existing_container(*command, interactive: T.unsafe(nil)); end

  # source://kamal//lib/kamal/commands/accessory.rb#74
  def execute_in_existing_container_over_ssh(*command); end

  # source://kamal//lib/kamal/commands/accessory.rb#63
  ...
  # source://kamal//lib/kamal/commands/accessory.rb#49
  ...
  # source://kamal//lib/kamal/commands/accessory.rb#39
  def info(all: T.unsafe(nil), quiet: T.unsafe(nil)); end

  # source://kamal//lib/kamal/commands/accessory.rb#5
  def label_args(*_arg0, **_arg1, &_arg2); end

  # source://kamal//lib/kamal/commands/accessory.rb#43
  ...
  # source://kamal//lib/kamal/commands/accessory.rb#96
  def remove_container; end

  # source://kamal//lib/kamal/commands/accessory.rb#100
  def remove_image; end

  # source://kamal//lib/kamal/commands/accessory.rb#92
  ...
  # source://kamal//lib/kamal/commands/accessory.rb#31
  def start; end

  # source://kamal//lib/kamal/commands/accessory.rb#35
  def stop; end
...
module Kamal::Commands::App::Proxy
  ...
  # source://kamal//lib/kamal/commands/app/proxy.rb#25
  def proxy_exec(*command); end
end
...
class Kamal::Commands::Base
  ...
  # source://kamal//lib/kamal/commands/base.rb#118
  ...
  # source://kamal//lib/kamal/commands/base.rb#108
...
class Kamal::Commands::Builder < ::Kamal::Commands::Base
  ...
  # source://kamal//lib/kamal/commands/builder.rb#31
  def local; end
  ...
  # source://kamal//lib/kamal/commands/builder.rb#27
  def remote; end
...
class Kamal::Commands::Builder::Base < ::Kamal::Commands::Base
  ...
  # source://kamal//lib/kamal/commands/builder/base.rb#45
  def build_context; end

  # source://kamal//lib/kamal/commands/builder/base.rb#41
  ...
  # source://kamal//lib/kamal/commands/builder/base.rb#58
  def first_mirror; end

  # source://kamal//lib/kamal/commands/builder/base.rb#31
  def info; end

  # source://kamal//lib/kamal/commands/builder/base.rb#37
  ...
  # source://kamal//lib/kamal/commands/builder/base.rb#27
  def pull; end
  ...
  # source://kamal//lib/kamal/commands/builder/base.rb#49
  ...
  # source://kamal//lib/kamal/commands/builder/base.rb#88
  def build_secrets; end

  # source://kamal//lib/kamal/commands/builder/base.rb#104
  def build_ssh; end

  # source://kamal//lib/kamal/commands/builder/base.rb#63
  def build_tag_names(tag_as_dirty: T.unsafe(nil)); end

  # source://kamal//lib/kamal/commands/builder/base.rb#69
  ...
  # source://kamal//lib/kamal/commands/builder/base.rb#116
  ...
  # source://kamal//lib/kamal/commands/builder/base.rb#120
...
class Kamal::Configuration::Accessory
  ...
  # @return [Boolean]
  #
  # source://kamal//lib/kamal/configuration/accessory.rb#187
  ...
  # source://kamal//lib/kamal/configuration/accessory.rb#233
  def ensure_valid_roles; end

  # source://kamal//lib/kamal/configuration/accessory.rb#183
  def expand_host_path(host_path); end

  # source://kamal//lib/kamal/configuration/accessory.rb#142
  def expand_local_file(local_file); end

  # source://kamal//lib/kamal/configuration/accessory.rb#161
  ...
  # source://kamal//lib/kamal/configuration/accessory.rb#195
  def hosts_from_host; end

  # source://kamal//lib/kamal/configuration/accessory.rb#199
  def hosts_from_hosts; end

  # source://kamal//lib/kamal/configuration/accessory.rb#203
  ...
  # source://kamal//lib/kamal/configuration/accessory.rb#131
  def initialize_registry; end

  # source://kamal//lib/kamal/configuration/accessory.rb#229
  def network; end
  ...
  # source://kamal//lib/kamal/configuration/accessory.rb#169
  def remote_files_as_volumes; end

  # source://kamal//lib/kamal/configuration/accessory.rb#191
  def service_data_directory; end

  # source://kamal//lib/kamal/configuration/accessory.rb#165
  def specific_volumes; end

  # source://kamal//lib/kamal/configuration/accessory.rb#150
...
class Kamal::Configuration::Builder
  ...
  # source://kamal//lib/kamal/configuration/builder.rb#103
  def cache_to; end
  ...
  # @return [Boolean]
  #
  # source://kamal//lib/kamal/configuration/builder.rb#143
  ...
  # @return [Boolean]
  #
  # source://kamal//lib/kamal/configuration/builder.rb#148
  def valid?; end
end
...
class Kamal::Configuration::Proxy
  ...
  # source://kamal//lib/kamal/configuration/proxy.rb#18
  def app_port; end
  ...
  # source://kamal//lib/kamal/configuration/proxy.rb#53
  def deploy_command_args(target:); end

  # source://kamal//lib/kamal/configuration/proxy.rb#30
  def deploy_options; end

  # source://kamal//lib/kamal/configuration/proxy.rb#26
  def hosts; end

  # source://kamal//lib/kamal/configuration/proxy.rb#68
  def merge(other); end
  ...
  # @return [Boolean]
  #
  # source://kamal//lib/kamal/configuration/proxy.rb#22
  def ssl?; end

  # source://kamal//lib/kamal/configuration/proxy.rb#64
  def stop_command_args(**options); end

  # source://kamal//lib/kamal/configuration/proxy.rb#57
  def stop_options(drain_timeout: T.unsafe(nil), message: T.unsafe(nil)); end

  private

  # source://kamal//lib/kamal/configuration/proxy.rb#77
  def error_pages; end

  # source://kamal//lib/kamal/configuration/proxy.rb#73
...
class Kamal::Configuration::Proxy::Boot
  ...
  # source://kamal//lib/kamal/configuration/proxy/boot.rb#104
  def ensure_valid_bind_ips(bind_ips); end

  # source://kamal//lib/kamal/configuration/proxy/boot.rb#113
...
class Kamal::Configuration::Role
  ...
  # source://kamal//lib/kamal/configuration/role.rb#210
  def role_config; end
...
class Kamal::Secrets::Adapters::BitwardenSecretsManager < ::Kamal::Secrets::Adapters::Base
  ...
  # @raise [RuntimeError]
  #
  # source://kamal//lib/kamal/secrets/adapters/bitwarden_secrets_manager.rb#64
  def check_dependencies!; end

  # @return [Boolean]
  #
  # source://kamal//lib/kamal/secrets/adapters/bitwarden_secrets_manager.rb#68
  def cli_installed?; end
  ...
  # @raise [RuntimeError]
  #
  # source://kamal//lib/kamal/secrets/adapters/bitwarden_secrets_manager.rb#59
  def login(account); end

  # source://kamal//lib/kamal/secrets/adapters/bitwarden_secrets_manager.rb#48
  def parse_secret(secret); end

  # source://kamal//lib/kamal/secrets/adapters/bitwarden_secrets_manager.rb#54
